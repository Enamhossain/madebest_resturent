...
function Login() {
  ...
  const { signInUser,googleSignIn, instagramSignIn,
    twitterSignIn, } = useContext(AuthContext)
  ...
  //  social media sing in
  const handleInstagramSignIn = () => {
    instagramSignIn()
      .then((result) => {
        // Instagram Sign-In successful, handle user data
        const user = result.user;
        console.log(user);
      })
      .catch((error) => {
  ...
  const handleTwitterSignIn = () => {
    twitterSignIn()
      .then((result) => {
        // Twitter Sign-In successful, handle user data
        const user = result.user;
        console.log(user);
      })
      .catch((error) => {
  ...
  return (
    <section className="bg-white">
      <Helmet>
        <title>Sing in | MadeBest</title>
      </Helmet>
      <div className="lg:grid lg:min-h-screen lg:grid-cols-12">
        <section className="relative flex h-32 items-end bg-gray-900 lg:col-span-5 lg:h-full xl:col-span-6">
          <img
            alt=""
            src="https://i.ibb.co/dtWgX84/high-protein-meal-with-smartphone-arrangement.jpg"
          ...
          <div className="max-w-xl lg:max-w-3xl">
            ...
            <div className="w-full max-w-md space-y-8 px-4 bg-white text-gray-600 sm:px-0">
              ...
              <div>
                ...
                <p className=" mb- text-center text-s=md bg-white px-2 mx-auto">Or continue with</p>

                <div className="space-y-4 text-sm font-medium">
                  <button onClick={() => handleGoogleSingIn()} className="w-full flex items-center justify-center gap-x-3 py-2.5 border rounded-lg hover:bg-gray-50 duration-150 active:bg-gray-100">
                  ...
                  <button onClick={() => handleTwitterSignIn()} className="w-full flex items-center justify-center gap-x-3 py-2.5 border rounded-lg hover:bg-gray-50 duration-150 active:bg-gray-100">
                    <svg className="w-5 h-5" viewBox="0 0 48 48" fill="none" xmlns="http://www.w3.org/2000/svg">
